...
\label{subsec:diag}
I figur \ref{fig:pc_diag} ett intrumentbräde för diagnostik och status samt i tabell \ref{tab:diag} dess funktionallitet.
...
\caption{Tabell över tolkning av meddelanden i loggfönstret}\\
    ...
    \endlastfoot
        ...
        Wrong checksum, was X expected Y & Paket mottaget med fel cheksum \\ \hline

...
\nyBild{Linormal.png}{Koncentration av olika typer av joner efter normal uppladdning}{linormal}{0.8}
...
\nyBild{Lioverchargd.png}{Koncentration av olika typer av joner efter överladdning}{lioverchargd}{0.8}
...
\nyBild{Kopplingschema-UART-till-halv-duplex.png}{Kopplingschema för att koppla ihop en AVR med Dynamixel AX-12A}{ax12-koppling}{0.8} 
...
Totalt finns det 26 olika parametrar som kan skrivas och avläsas och ytterligare 10 parametrar som endast kan avläsas. 
...
\bibitem{overcharging} R. A. Leising, M. J. Palazzo, E. Sans Takeuchi, K. J. Takeuchi, \emph{A study of the overcharge reaction of lithium-ion batteries}
...
\bibitem{better-battery} R. Van Noorden, \emph{The rechargeable revolution: A better battery} \\ Nature, volym 507, mars 2014, sidor 26-28

\bibitem{li-s} M. Song, Y. Zhang, E. J. Cairns, \emph{A Long-Life, High-Rate Lithium/Sulfur Cell: A Multifaceted Approach to Enhancing Cell Performance} \\ Nano Lett., 13, 2013, sidor 5891-5899

\bibitem{capacitors} A. Yu, V. Chabot, J. Zhang, \emph{Electrochemical supercapacitors for energy storage and delivery} \\ Taylor \& Francis, 2013

\bibitem{litium-in-cars} J. Voelcker, \emph{Lithium Batteries Take to the Road} \\
